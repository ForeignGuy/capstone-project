			...
			if (!isset($_SESSION['Username'])) { echo "
				<form method='POST' action='PHP_Actions/Login_Or_Register.php'>
					<br><h1> Register </h1> <br><br>
						...
						<input placeholder='Email Address' type='email' id='Email_Address' size='75' required >

						<br><br>


						<input placeholder='Username' type='text' id='Username' size='75' required>

						<br><br>


						<input placeholder='Password' type='password' id='Password' size='75' pattern='(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}' title='Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters' required>
						<div align= 'center'>
						...
						<input placeholder=Phone Number type='tel'  id='Phone_Number' size='75' pattern='[0-9]{3}-[0-9]{3}-[0-9]{4}' title= 'please follow this format, xxx-xxx-xxxx'
            required>
